...
def getContours(binary_image):
    contours, hierachy = cv2.findContours(binary_image.copy(),
...
def main():
    image_name = 'src/open_cv/images/tennisball01.jpg'  # area > 100
    yellowLower = (30,150,100)
    yellowUpber = (50,255,255)
    rgb_image = read_rgb_image(image_name, True)
    binary_image_mask = filter_color(rgb_image, yellowLower, yellowUpber)
